...
if (!defined('SAPCLASSES_DIR'))
    define('SAPCLASSES_DIR', dirname(__FILE__));

// Define status values
if (!defined("SAPRFC_OK"))
    define("SAPRFC_OK", 0);
if (!defined("SAPRFC_ERROR"))
    define("SAPRFC_ERROR", 1);
if (!defined("SAPRFC_APPL_ERROR"))
    define("SAPRFC_APPL_ERROR", 99);
